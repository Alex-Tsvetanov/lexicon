...
% NB: кръпката ТРЯБВА да е СЛЕД tocloft, защото пакетът предефинира \l@section и
...
% Слот за генерирани макроси с числа. Идеята е числата в текста да идват от файл,
% произведен от измерванията, за да не може изречение да противоречи на таблица.
% Разкоментира се, когато инструментът за измерване започне да произвежда този файл.
% \input{generated/measurements_macros}
...
\lstset{
    ...
    emph={lexicon, transducer, analyzer, morph_reading, token, chart, earley_item,
          parse_forest, parse_tree, semantic_frame, logical_form, query_plan,
          sql_emitter, sparql_emitter, surface_realizer},
